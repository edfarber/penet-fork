...
/users/edfarber/scratch/penet-fork/.venv/bin/python parse_raw_dicom.py --input_dir /data4/intermountain/CTPA/test --output_dir ~/  --csv_path /data4/intermountain2/intermountain_combined.csv
